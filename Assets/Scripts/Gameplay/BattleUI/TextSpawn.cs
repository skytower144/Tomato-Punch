...
public class TextSpawn : MonoBehaviour
{
    ...
    [SerializeField] private GameObject defaultCartridge, KOText, YouWin_Text, YouLose_Text, FIGHT_Text, round2_Text, dark_filter, missEffect, resultCard, continueBundle;
